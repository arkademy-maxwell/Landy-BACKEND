...
module.exports ={
    getAllFlightFacilities: (req, res) =>{
        flightFacilitiesModel.getAllFlightFacilities()
            .then(resultQuery =>{
                res.json({
                    status : 200,
                    message: 'success',
    ...
    addFlightFacilities: (req, res) =>{
        ...
        flightFacilitiesModel.addFlightFacilities(data)
        .then(result =>{
            res.json({
                status : 200,
                message: 'Suksess',
        ...
        updateFlightFacilities:(req, res)=>{
            ...
            flightFacilitiesModel.updateFlightFacilities(data, id)
            .then(result =>{
                res.json({
                    status:200,
                    message: 'Suksess',
        ...
        deleteFlightFacilities: (req, res)=>{
            ...
            flightFacilitiesModel.deleteFlightFacilities(req.params.id)
            .then(result =>{
                res.json({
                    status: 200,
                    message: 'Suksess',
