const discountFlightModel = require('../models/discountFlight')
const uuid = require("uuid/v4");

module.exports = {
  getDiscount: (req, res) => {
    discountFlightModel.getDiscount()
      .then(resultQuery => {
        res.json({
          status: 200,
  ...
  addDiscount: (req, res) => {
    ...
    discountFlightModel.addDiscount(data)
      .then(result => {
        res.json({
          status: 200,
  ...
  updateDiscount: (req, res) => {
    ...
    discountFlightModel.updateDiscount(data, id)
      .then(result => {
        res.json({
          status: 200,
  ...
  deleteDiscount: (req, res) => {
    ...
    discountFlightModel.deleteDiscount(id)
      .then(result => {
        res.json({
          status: 200,
